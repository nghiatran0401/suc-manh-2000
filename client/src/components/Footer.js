...
export default function Footer() {
  return (
    <Box bgcolor={"#262626"}>
      <Box display={"flex"} flexDirection={"column"} gap={"24px"} maxWidth={"1080px"} m={"auto"}>
        <Box display={"flex"} flexDirection={"row"} alignItems={"center"} gap={"24px"} p={"40px 0"}>
        ...
        <Grid container spacing={8} display={"flex"} justifyContent={"space-between"} pb={"40px"}>
          <Grid item>
        ...
        <Box display={"flex"} flexDirection={"row"} alignItems={"center"} justifyContent={"center"} pb={"40px"}>
